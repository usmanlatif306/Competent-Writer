...
class SitemapController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $contents['services'] = EssayWriting::select('updated_at', 'slug')->first()->pluck('updated_at', 'slug')['essay-writing'];
        ...
        $data['routes'] = [
            ...
            'service_page' => [
                'route' => '',
                'date' => optional($contents)['services']
            ],
            'contact_page' => [
                'route' => '',
