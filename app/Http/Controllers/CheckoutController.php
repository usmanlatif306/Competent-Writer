...
class CheckoutController extends Controller
{
    ...
    public function handleSuccessfullOnlinePayment(Request $request, ApiOrderService $apiOrder)
    {
        ...
        if ($this->cart->getCartType() == CartType::NewOrder) {
            ...
            // payment is successfull and create api order
    ...
    public function processWalletPayment(Request $request, ApiOrderService $apiOrder)
    {
