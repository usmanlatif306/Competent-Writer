    ...
    <div>
      ...
      <span class="small">3</span> TYPE OF WORK AND DEADLINE
        ...
        <div class="form-row">
            ...
            <div class="form-group col-6" v-if="form.sub_category">
            ...
            >
                <label>Number of pages <small>(275 words/page)</small></label>
            ...
            >
                <label>Number of Words <small>(275 words/page)</small></label>
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        <button
                            type="button"
                ...
                <div class="form-group">
                    ...
                    <div class="d-flex custom-border rounded">
                        <Datepicker
                            ...
                            :disabled="isDisable"
                            :input-class="isDisable ? 'date-disabled' : ''"
                        ></Datepicker>
                        <input
                            type="time"
...
export default {
    ...
    data() {
        return {
            ...
            form: {
                ...
                work_level_model: this.levels ? this.levels[1] : {},
                work_level_id: this.levels ? this.levels[1].id : 1,
                ...
                number_of_slides: this.services[0].minimum_order_quantity,
                spacing_type: "double",
                added_services: [],
    ...
    methods: {
        ...
        getAdditionalServices(service_model) {
            ...
            if (service_model.name === "Online Class") {
                this.isDisable = true;
            } else {
            ...
            if (parseInt(service_model.parent) === 0) {
                var $form = this;
                axios
                    .post(this.sub_categories_by_service_id, {
                        service_id: service_id
                    })
                    .then(function(response) {
                        $form.sub_categories = response.data;
                        $form.form.sub_category = $form.sub_categories[0];
                    })
