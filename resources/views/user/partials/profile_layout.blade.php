...
<section class="pt-5 pt-lg-0">
   <div class="container">
      <div class="row">
         <div class="col-lg-4">
            <div class="sticky-top mt-n175" data-toggle="sticky" data-sticky-offset="30"
               data-negative-margin=".card-profile-cover">
               <div class="card card-profile border-0">
                  <div class="card-profile-cover">
                     <img alt="Image placeholder" src="{{ $photo_url }}" class="card-img-top user-avatar">
                  </div>
                  <div class="mx-auto">
                     <img alt="Image placeholder" src="{{ $photo_url }}"
                        class="card-profile-image avatar rounded-circle shadow hover-shadow-lg user-avatar">
                  </div>
