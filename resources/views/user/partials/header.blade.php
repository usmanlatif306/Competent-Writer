    ...
    <div class="container pt-4 pt-lg-0">
        <div class="row justify-content-end">
            <div class=" col-lg-8">
                ...
                <!-- Account navigation -->
                <div class="d-flex">
                    <a href="{{ route('users_edit', $user->id) }}" class="btn btn-neutral">
                    ...
                    <div class="btn-group btn-group-nav shadow ml-auto" role="group" aria-label="Basic example">
                        <div class="btn-group" role="group">
                            <a class="btn btn-neutral" href="{{ route('user_profile', $user->id) }}">
                                <i class="far fa-address-card"></i> Profile
                            </a>

                            <div class="btn-group" role="group">
                                <button id="btn-group-settings" type="button" class="btn btn-neutral"
