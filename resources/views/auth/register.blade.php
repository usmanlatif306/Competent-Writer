...
<div class="wrap-login100 p-l-110 p-r-110 p-t-62 p-b-33">
    <form class="login100-form validate-form flex-sb flex-w" method="POST" action="{{ route('register') }}">
        ...
        <div class="wrap-input100 validate-input m-t-30">
            <input class="input100 @error('first_name') focus-error100 @enderror" type="text" placeholder="First Name"
        ...
        <div class="wrap-input100 validate-input m-t-10">
            <input class="input100 @error('last_name') focus-error100 @enderror" type="text" name="last_name"
